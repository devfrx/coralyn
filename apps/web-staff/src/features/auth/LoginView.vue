...
<template>
  <AuthLayout>
    ...
    <p data-testid="legal-links" class="mt-6 text-center text-[12px] text-[var(--color-text-muted)]"><RouterLink :to="{ name: 'legal-privacy' }" class="underline">Informativa privacy</RouterLink> · <RouterLink :to="{ name: 'legal-imprint' }" class="underline">Note legali</RouterLink></p>
  </AuthLayout>
</template>
