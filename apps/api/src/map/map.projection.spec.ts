      ...
      rows: [
        {
          ...
          sortOrder: 1,
          umbrellas: [
            { id: 'u1', establishmentId: 'e', rowId: 'row1', umbrellaTypeId: 't1', label: '1', logicalOrder: 1, retiredAt: null, retiredFrom: null, retiredFromSectorId: null, presentationPosition: null },
            { id: 'u2', establishmentId: 'e', rowId: 'row1', umbrellaTypeId: null, label: '2', logicalOrder: 2, retiredAt: null, retiredFrom: null, retiredFromSectorId: null, presentationPosition: null },
          ],
        },
      ],
    },
